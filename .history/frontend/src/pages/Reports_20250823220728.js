...
function Reports() {
  ...
  const formatScanType = (scanType) => {
    ...
    if (scanType === "invoice" || scanType === "invoice_file") return t("scanner.invoiceTab");
    return scanType;
  };
  ...
  const formatExplanation = (explanation) => {
    ...
    if (explanation.includes("safe")) return t("explanation.safe");
    if (explanation.includes("Suspicious")) return t("explanation.suspicious");
    if (explanation.includes("High-risk")) return t("explanation.malicious");
            ...
            {reports.length > 0 ? (
              reports.map((r, i) => (
                ...
                >
                  ...
                  >
                    {formatExplanation(r.explanation)}
                  </td>
                  <td style={cellStyle}>
