...
function Dashboard() {
  ...
  return (
    <div style={{ padding: "20px", background: theme === "dark" ? "#121212" : "#f4f6f9", minHeight: "100vh" }}>
      <h2 style={{ marginBottom: "20px", color: theme === "dark" ? "#fff" : "#333" }}>{t("dashboard.title")}</h2>
      ...
      <div style={sectionStyle}>
        ...
        <table style={tableStyle}>
          <thead>
            <tr>
              <th style={thStyle}>#</th>
              <th style={thStyle}>{t("scanner.emailTab")}/{t("scanner.invoiceTab")}</th>
              ...
              <tr key={i}>
                ...
                <td
                  style={{
                    ...
                    fontWeight: "600",
                    color:
                      h.verdict === "SAFE" ? "green" : h.verdict === "SUSPICIOUS" ? "#ff9800" : "red",
                  }}
                >
                  {h.verdict}
                </td>
