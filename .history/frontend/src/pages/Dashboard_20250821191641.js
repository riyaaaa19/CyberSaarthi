...
function Dashboard() {
  ...
  const doughnutData = {
    labels: [
      t("dashboard.safe"),
      t("dashboard.suspicious"),   // ✅ updated
      t("dashboard.malicious"),    // ✅ updated
    ],
    datasets: [
      {
  ...
  const verdictMap = {
    SAFE: t("email.safe"),
    SUSPICIOUS: t("email.suspicious"),  // ✅ updated
    MALICIOUS: t("email.malicious"),    // ✅ updated
  };
    ...
    >
      ...
      >
        ...
        <div style={{ ...cardBase, background: "#ff9800" }}>
          <h4>{t("dashboard.suspicious")}</h4> {/* ✅ updated */}
          <h1>{summary.suspicious}</h1>
        </div>
        <div style={{ ...cardBase, background: "#f44336" }}>
          <h4>{t("dashboard.malicious")}</h4> {/* ✅ updated */}
