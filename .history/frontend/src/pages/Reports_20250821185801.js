...
function Reports() {
  ...
  return (
    ...
    >
      <h2 style={{ fontSize: "22px", marginBottom: "15px", color: theme === "dark" ? "#fff" : "#333" }}>
        {t("reports.title")}
      </h2>
      ...
      >
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "14px" }}>
          <thead>
            <tr style={{ backgroundColor: theme === "dark" ? "#333" : "#f4f6f8" }}>
            ...
            {reports.length > 0 ? (
              reports.map((r, i) => (
                <tr
                  key={i}
                  style={{
                    backgroundColor: i % 2 === 0 ? (theme === "dark" ? "#1a1a1a" : "#ffffff") : theme === "dark" ? "#2a2a2a" : "#f9f9f9",
                    transition: "background 0.2s",
                  }}
                  onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = theme === "dark" ? "#333" : "#eef5ff")}
                  onMouseLeave={(e) =>
                    (e.currentTarget.style.backgroundColor =
                      i % 2 === 0 ? (theme === "dark" ? "#1a1a1a" : "#ffffff") : theme === "dark" ? "#2a2a2a" : "#f9f9f9")
                  }
                >
                  ...
                  <td style={{ ...cellStyle, maxWidth: "250px", whiteSpace: "pre-wrap" }}>
                    {r.explanation}
                  </td>
              ...
              <tr>
                <td style={{ ...cellStyle, textAlign: "center", padding: "20px" }} colSpan="6">
