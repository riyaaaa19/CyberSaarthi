...
const MESSAGES = {
  en: {
    ...
    "email.scanText": "Scan Email",   // ✅ Added

    // Invoice Scanner
    "invoice.title": "Invoice Scanner",
    ...
    "invoice.scanText": "Scan Invoice",   // ✅ Updated to be clear
  ...
  hi: {
    ...
    "email.scanText": "ईमेल स्कैन करें",   // ✅ Added

    // Invoice Scanner
    "invoice.title": "इनवॉइस स्कैनर",
    ...
    "invoice.scanText": "इनवॉइस स्कैन करें",   // ✅ Updated
