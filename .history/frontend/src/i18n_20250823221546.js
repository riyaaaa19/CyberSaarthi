...
const MESSAGES = {
  en: {
    ...
    "settings.showHistory": "Show History", // ✅ Added
    "settings.save": "Save",
  ...
  hi: {
    ...
    "explanation.invoice.bankDetails":
      "बैंक विवरण बिना जीएसटीआईएन संदर्भ के",
    "explanation.invoice.accountNumber":
    ...
    "settings.showHistory": "इतिहास दिखाएं", // ✅ Added
