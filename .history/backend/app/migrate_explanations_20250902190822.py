...
# Run with: python backend/app/migrate_explanations.py
    ...
    for r in reports:
        ...
        if isinstance(r.explanation, dict):
            ...
            try:
                ...
                explanation_obj = None
        if explanation_obj and isinstance(explanation_obj, dict) and "en" in explanation_obj and "hi" in explanation_obj:
            continue
