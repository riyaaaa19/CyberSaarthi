...
MESSAGES = {
    "en": {
        ...
        # Phishing reason details
        "phishing.reason.phishingTerms": "Contains high-risk phishing terms",
        "phishing.reason.uppercase": "Unusually high uppercase ratio",
        "phishing.reason.blocklist": "Blocklisted domain detected",
        "phishing.reason.suspiciousDomain": "Suspicious domain found",
        "phishing.reason.domainPattern": "Suspicious domain pattern",
        "phishing.reason.punycode": "Punycode-like domain detected",
    ...
    "hi": {
        ...
        # Phishing reason details
        "phishing.reason.phishingTerms": "उच्च जोखिम वाले फ़िशिंग शब्द शामिल हैं",
        "phishing.reason.uppercase": "असामान्य रूप से अधिक अपरकेस अनुपात",
        "phishing.reason.blocklist": "ब्लॉकलिस्टेड डोमेन पाया गया",
        "phishing.reason.suspiciousDomain": "संदिग्ध डोमेन पाया गया",
        "phishing.reason.domainPattern": "संदिग्ध डोमेन पैटर्न",
        "phishing.reason.punycode": "प्युनिकोड जैसा डोमेन पाया गया",
