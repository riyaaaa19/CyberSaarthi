...
from app.utils.i18n import msg, translate_explanation
...
def evaluate_invoice(text: str, lang: str = "en") -> InvoiceVerdict:
    ...
    explanations = reasons.copy()

    if risk >= 0.7:
        verdict = Verdict.MALICIOUS
        explanations.insert(0, msg(lang, "invoice.mal"))
    elif risk >= 0.45:
        verdict = Verdict.SUSPICIOUS
        explanations.insert(0, msg(lang, "invoice.susp"))
    else:
        verdict = Verdict.SAFE
        explanations.insert(0, msg(lang, "invoice.safe"))
