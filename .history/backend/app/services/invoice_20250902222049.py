...
from ..utils.i18n import msg, translate_explanation
...
def evaluate_invoice(text: str, lang: str = "en") -> InvoiceVerdict:
    ...
    explanations = [msg(lang, "invoice.mal") if risk >= 0.7 else msg(lang, "invoice.susp") if risk >= 0.45 else msg(lang, "invoice.safe")]
    explanations.extend(reasons)

    # Ensure all lines are localized
    explanations = [msg(lang, key) if key in MESSAGES.get(lang, {}) else key for key in explanations]
